...
import type { SlimServiceHealth, SortBy } from "@/features/services-monitor/types";
...
const ServiceTableRow = memo(function ServiceTableRow({
  ...
  return (
    <tr
      ...
      className="cursor-pointer transition-colors hover:bg-accent/50 focus-visible:outline focus-visible:outline-2 focus-visible:-outline-offset-2 focus-visible:outline-ring [content-visibility:auto] [contain-intrinsic-size:1px_56px]"
    >
      ...
      <td className="px-4 py-3">
        <Badge variant={meta.badge}>
          <StatusIcon className={cn("size-3", meta.text)} aria-hidden />
          {meta.label}
        </Badge>
      </td>
